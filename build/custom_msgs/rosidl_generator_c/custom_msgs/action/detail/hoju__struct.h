...
enum
{
  custom_msgs__action__Hoju_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  custom_msgs__action__Hoju_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Hoju in the package custom_msgs.
typedef struct custom_msgs__action__Hoju_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  custom_msgs__action__Hoju_SendGoal_Request__Sequence request;
  custom_msgs__action__Hoju_SendGoal_Response__Sequence response;
} custom_msgs__action__Hoju_SendGoal_Event;

// Struct for a sequence of custom_msgs__action__Hoju_SendGoal_Event.
typedef struct custom_msgs__action__Hoju_SendGoal_Event__Sequence
{
...
enum
{
  custom_msgs__action__Hoju_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  custom_msgs__action__Hoju_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Hoju in the package custom_msgs.
typedef struct custom_msgs__action__Hoju_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  custom_msgs__action__Hoju_GetResult_Request__Sequence request;
  custom_msgs__action__Hoju_GetResult_Response__Sequence response;
} custom_msgs__action__Hoju_GetResult_Event;

// Struct for a sequence of custom_msgs__action__Hoju_GetResult_Event.
typedef struct custom_msgs__action__Hoju_GetResult_Event__Sequence
{
