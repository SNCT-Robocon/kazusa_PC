...
: ${AMENT_CURRENT_PREFIX:="/home/kazusa/kazusa/install/amcl_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amcl_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amcl_config/environment/path.sh"
