...
#include "custom_msgs/msg/detail/can_packet__rosidl_typesupport_fastrtps_c.h"
...
using _CanPacket__ros_msg_type = custom_msgs__msg__CanPacket;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__CanPacket;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_msgs__msg__CanPacket * ros_message = static_cast<const custom_msgs__msg__CanPacket *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_msgs__msg__CanPacket(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_msgs__msg__CanPacket * ros_message = static_cast<custom_msgs__msg__CanPacket *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_msgs__msg__CanPacket(cdr, ros_message);
}

static uint32_t _CanPacket__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__CanPacket(
...
static size_t _CanPacket__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__CanPacket(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, CanPacket)() {
