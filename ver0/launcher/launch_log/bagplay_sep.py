...
def generate_launch_description():
    ...
    pkg_dir="/home/suzuka/kannon/offseason_kaihatu/ver0/ekf_config_pkg"
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='rf2o_laser_odometry_front',
            output='log',
            parameters=[{
                'use_sim_time': LaunchConfiguration('use_sim_time'),
                'laser_scan_topic' : '/front_scan',
                'odom_topic' : '/odom_front',
                'publish_tf' : False,
        ...
        Node(
            package='rf2o_laser_odometry',
            executable='rf2o_laser_odometry_node',
            name='rf2o_laser_odometry_back',
            output='log',
            parameters=[{
                'use_sim_time': LaunchConfiguration('use_sim_time'),
                'laser_scan_topic' : '/back_scan',
                'odom_topic' : '/odom_back',
                'publish_tf' : False,
                'base_frame_id' : 'base_link',
                'odom_frame_id' : 'odom',
                'init_pose_from_topic' : '',
        ...
        output='screen',
        parameters=[ekf_config, {'use_sim_time': LaunchConfiguration('use_sim_time'),'publish_tf' : True},
