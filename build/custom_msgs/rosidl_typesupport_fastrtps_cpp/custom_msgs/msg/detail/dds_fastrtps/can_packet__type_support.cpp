...
#include "custom_msgs/msg/detail/can_packet__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::CanPacket & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::CanPacket & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::CanPacket;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::CanPacket *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::CanPacket *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_CanPacket__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, CanPacket)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_CanPacket__handle;
}
