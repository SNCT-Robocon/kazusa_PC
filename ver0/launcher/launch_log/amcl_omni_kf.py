...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        #     arguments=["0.325", "0.5", "0", "0", "0", "0", "1", "map", "base_link"]
        # ),
        Node(
            package="tf2_ros",
            executable="static_transform_publisher",
        ...
        Node(
            package="tf2_ros",
            executable="static_transform_publisher",
            arguments=["0.33532", "0", "0", "0", "0", "0", "1", "base_link", "laser"]
        ),
         Node(
            package="tf2_ros",
            executable="static_transform_publisher",
            arguments=["-0.33532", "0", "0", "0", "0", "1", "0", "base_link", "laser2"]
        ),
        # Node(
        #     package="tf2_ros",
        #     executable="static_transform_publisher",
        ...
        output='screen',
        parameters=[ {'use_sim_time': LaunchConfiguration('use_sim_time')},ekf_config,
                    ],
        remappings=[
