...
#ifndef CONTROLLER__MSG__DETAIL__CONTROLLER__FUNCTIONS_H_
#define CONTROLLER__MSG__DETAIL__CONTROLLER__FUNCTIONS_H_
 ...
 * calls
 * controller__msg__Controller__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller
controller__msg__Controller *
controller__msg__Controller__create(void);

/// Destroy msg/Controller message.
/**
 * It calls
 * controller__msg__Controller__fini()
 ...
 * controller__msg__Controller__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * controller__msg__Controller__Sequence__fini()
 * on the array,
...
#endif  // CONTROLLER__MSG__DETAIL__CONTROLLER__FUNCTIONS_H_
