...
inline std::string to_yaml(const Hoju_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use custom_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const custom_msgs::action::Hoju_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  custom_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use custom_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const custom_msgs::action::Hoju_SendGoal_Event & msg)
{
  return custom_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<custom_msgs::action::Hoju_SendGoal_Event>()
{
  return "custom_msgs::action::Hoju_SendGoal_Event";
}

template<>
inline const char * name<custom_msgs::action::Hoju_SendGoal_Event>()
{
  return "custom_msgs/action/Hoju_SendGoal_Event";
}

template<>
struct has_fixed_size<custom_msgs::action::Hoju_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<custom_msgs::action::Hoju_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<custom_msgs::action::Hoju_SendGoal_Request>::value && has_bounded_size<custom_msgs::action::Hoju_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<custom_msgs::action::Hoju_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const Hoju_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const Hoju_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use custom_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const custom_msgs::action::Hoju_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  custom_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use custom_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const custom_msgs::action::Hoju_GetResult_Event & msg)
{
  return custom_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<custom_msgs::action::Hoju_GetResult_Event>()
{
  return "custom_msgs::action::Hoju_GetResult_Event";
}

template<>
inline const char * name<custom_msgs::action::Hoju_GetResult_Event>()
{
  return "custom_msgs/action/Hoju_GetResult_Event";
}

template<>
struct has_fixed_size<custom_msgs::action::Hoju_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<custom_msgs::action::Hoju_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<custom_msgs::action::Hoju_GetResult_Request>::value && has_bounded_size<custom_msgs::action::Hoju_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<custom_msgs::action::Hoju_GetResult_Event>
  : std::true_type {};
