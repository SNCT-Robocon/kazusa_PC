...
include "trajectory_builder_static.lua"
...
--MAP_BUILDER.pure_localization=true
MAP_BUILDER.use_trajectory_builder_2d = true
--TRAJECTORY_BUILDER_2D.pure_localization = options.pure_localization  -- SLAMモードを有効にする
--MAP_BUILDER.num_trajectory_builders = 1
...
--local slam faster
TRAJECTORY_BUILDER_2D.voxel_filter_size = 0.07        -- 増やす デフォルト： 0.025
...
POSE_GRAPH.constraint_builder.max_constraint_distance = 1   -- 近傍のみで制約
POSE_GRAPH.constraint_builder.sampling_ratio = 1.0             -- 制約構築を抑制
POSE_GRAPH.constraint_builder.min_score = 0.45                 -- マッチ閾値を厳しく
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.85  -- デフォルト: 0.6 -> 0.7
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 170 -- 10 -> 200
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 310   -- 40 -> 400 
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 11
...
-- デフォルト: 1.  -> 10
TRAJECTORY_BUILDER_2D.submaps.num_range_data =150  -- デフォルト: 90  -> 
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.insert_free_space = false
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.hit_probability = 0.5000000000000001
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.miss_probability= 0.4999999999999999

TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.14    -- デフォルト: 0.2 -> 0.1
