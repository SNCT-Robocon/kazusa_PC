    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.action.FollowPath_Goal')
            logger.debug(
...
class Metaclass_FollowPath_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_msgs.action.FollowPath_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_FollowPath_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_msgs.action.FollowPath_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_Feedback(metaclass=Metaclass_FollowPath_Feedback):
    ...
    def __init__(self, **kwargs):
        ...
        self.now_x = kwargs.get('now_x', float())
        self.now_y = kwargs.get('now_y', float())
        self.now_yaw = kwargs.get('now_yaw', float())
    ...
    def __eq__(self, other):
        ...
        if self.ref_yaw != other.ref_yaw:
            return False
        if self.now_x != other.now_x:
            return False
        if self.now_y != other.now_y:
            return False
        if self.now_yaw != other.now_yaw:
            return False
        return True
    ...
    def now_x(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'now_x' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'now_x' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._now_x = value
    ...
    def now_y(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'now_y' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'now_y' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._now_y = value

    @builtins.property
    def now_yaw(self):
        """Message field 'now_yaw'."""
        return self._now_yaw

    @now_yaw.setter
    def now_yaw(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'now_yaw' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'now_yaw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._now_yaw = value
...
class Metaclass_FollowPath_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_msgs.action import FollowPath
...
class FollowPath_SendGoal_Request(metaclass=Metaclass_FollowPath_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'custom_msgs/FollowPath_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_msgs.action._follow_path import FollowPath_Goal
...
class Metaclass_FollowPath_SendGoal_Event(type):
...
class FollowPath_SendGoal_Event(metaclass=Metaclass_FollowPath_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<custom_msgs/FollowPath_SendGoal_Request, 1>',
        'response': 'sequence<custom_msgs/FollowPath_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_msgs.action import FollowPath_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FollowPath_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from custom_msgs.action import FollowPath_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FollowPath_SendGoal_Response'"
...
class Metaclass_FollowPath_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_msgs.action.FollowPath_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_msgs.action import _follow_path
...
class FollowPath_SendGoal(metaclass=Metaclass_FollowPath_SendGoal):
    from custom_msgs.action._follow_path import FollowPath_SendGoal_Request as Request
    from custom_msgs.action._follow_path import FollowPath_SendGoal_Response as Response
    from custom_msgs.action._follow_path import FollowPath_SendGoal_Event as Event
...
class FollowPath_GetResult_Response(metaclass=Metaclass_FollowPath_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'custom_msgs/FollowPath_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from custom_msgs.action._follow_path import FollowPath_Result
...
class Metaclass_FollowPath_GetResult_Event(type):
...
class FollowPath_GetResult_Event(metaclass=Metaclass_FollowPath_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<custom_msgs/FollowPath_GetResult_Request, 1>',
        'response': 'sequence<custom_msgs/FollowPath_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_msgs.action import FollowPath_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FollowPath_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from custom_msgs.action import FollowPath_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FollowPath_GetResult_Response'"
        self._response = value
...
class Metaclass_FollowPath_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_msgs.action.FollowPath_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_GetResult(metaclass=Metaclass_FollowPath_GetResult):
    from custom_msgs.action._follow_path import FollowPath_GetResult_Request as Request
    from custom_msgs.action._follow_path import FollowPath_GetResult_Response as Response
    from custom_msgs.action._follow_path import FollowPath_GetResult_Event as Event
...
class Metaclass_FollowPath_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_msgs.action.FollowPath_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FollowPath_FeedbackMessage(metaclass=Metaclass_FollowPath_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'custom_msgs/FollowPath_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_msgs', 'action'], 'FollowPath_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from custom_msgs.action._follow_path import FollowPath_Feedback
...
class FollowPath(metaclass=Metaclass_FollowPath):
    ...
    from custom_msgs.action._follow_path import FollowPath_Goal as Goal
    # The result message defined in the action definition.
    from custom_msgs.action._follow_path import FollowPath_Result as Result
    # The feedback message defined in the action definition.
    from custom_msgs.action._follow_path import FollowPath_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from custom_msgs.action._follow_path import FollowPath_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from custom_msgs.action._follow_path import FollowPath_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from custom_msgs.action._follow_path import FollowPath_FeedbackMessage as FeedbackMessage
